  ...
  Section(
    ...
    resources=[
      ...
      Resource(
        ...
        github_url="https://github.com/google-gemini/gemma-cookbook/blob/main/Gemma/[Gemma_2]Using_with_Mesop.ipynb",
      ...
      Resource(
        ...
        github_url="https://github.com/google-gemini/gemma-cookbook/blob/main/PaliGemma/[PaliGemma_1]Using_with_Mesop.ipynb",
