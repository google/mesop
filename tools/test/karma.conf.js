// Forked from: https://github.com/angular/components/blob/8ac3ca11add4ae194b2b79169559fb3dbad7e161/test/karma.conf.js
...
module.exports = (config) => {
  config.set({
    ...
    files: [
      ...
      {
        pattern: 'node_modules/zone.js/bundles/zone.umd.min.js',
        included: true,
        watched: false,
      },
      {
        pattern: 'node_modules/zone.js/bundles/proxy.umd.min.js',
        included: true,
        watched: false,
      },
      {
        pattern: 'node_modules/zone.js/bundles/sync-test.umd.js',
        included: true,
        watched: false,
      },
      {
      ...
      {
        pattern: 'node_modules/zone.js/bundles/async-test.umd.js',
        included: true,
        watched: false,
      },
      {
      ...
      {
        pattern: 'node_modules/luxon/build/amd/**/*',
        included: false,
        watched: false,
      },
      {
      ...
      {
        pattern: 'dist/legacy-test-bundle.spec.js',
        included: true,
        watched: false,
      },
  ...
  if (process.env['CI']) {
    ...
    const maxParallelContainerInstances =
      Number(process.env['CI_NODE_TOTAL']) || 1;
