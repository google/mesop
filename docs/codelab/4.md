## 4. Integrating Multiple AI Models
...
Now, let's update our `main.py` file to integrate these AI models. We'll modify the `send_prompt` function to handle multiple models and display their responses:
