...
from mesop.examples.web_component.named_slots.counter_component import (
  counter_component,
)
from mesop.examples.web_component.named_slots.outer_component import (
  outer_component,
)
...
@me.page(
  path="/web_component/named_slots/named_slots_app",
