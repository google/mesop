// Copied from: https://github.com/angular/components/blob/ff67a416d19e9237607605bec0d7cc372025387f/src/material/checkbox/checkbox.ts
...
export class MatCheckbox
  implements AfterViewInit, ControlValueAccessor, FocusableOption
{
  ...
  _preventBubblingFromLabel(event: MouseEvent) {
    if (
      !!event.target &&
      this._labelElement.nativeElement.contains(event.target as HTMLElement)
    ) {
      event.stopPropagation();
    }
  }
